...
const balanceTransactionSchema = new mongoose.Schema({
    ...
    type: {
        type: String,
        required: true,
        enum: ['bet_placed', 'bet_win', 'deposit', 'withdraw', 'withdraw_reject', "sweep", 'redeem', 'winstreak_reward', "affiliate_reward", "apple_reward_register", "apple_reward_deposit", "clan_created", "clan_deposit", "clan_distribute"]
    },
