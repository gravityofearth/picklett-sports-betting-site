          ...
          <table className="w-full border-collapse">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="py-4 px-2 align-text-top">10,000 Clan XP</td>
              ...
              <tr>
                ...
                <td className="py-4 px-2 align-text-top">500,000 Clan XP</td>
                <td className="pl-2 py-4 pr-6 flex flex-col gap-2">
              ...
              <tr>
                ...
                <td className="py-4 px-2 align-text-top">2,000,000 Clan XP</td>
                <td className="pl-2 py-4 pr-6 flex flex-col gap-2">
