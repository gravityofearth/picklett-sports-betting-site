    ...
    <div className="flex justify-center">
      <div className="w-full max-w-7xl flex flex-col gap-10">
        <Link href="../../clan-wars" className="flex gap-2 cursor-pointer hover:underline">
          ...
          <span className="text-2xl leading-6  select-none">Back to Clan</span>
        </Link>
        <div className="w-full flex flex-col items-center gap-6 p-6 rounded-2xl bg-[#1475E1]/10">
          <div className="flex gap-1 items-center">
            ...
            <span className="text-xl  leading-6 ">24h Wins War</span>
          </div>
          <div className="w-full px-6 flex justify-between items-center">
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-2xl leading-6 ">Elite Bettors</span>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <div className="flex gap-2 items-center py-1 px-2 bg-[#1475E1]/20 rounded-lg">
                <svg className="w-6 h-6"><use href="#svg-clan-coffer" /></svg>
                <div className="text-xl text-white/70">Winner takes: <span className="text-white ">$4000</span></div>
              </div>
            </div>
            <div className="flex flex-col items-center gap-2">
              <Image alt="avatar" src={`/api/profile/avatar-todo`} width={64} height={64} className="shrink-0 rounded-full w-[64px] h-[64px]" />
        ...
        <div className="flex flex-col gap-4">
          <span className="text-2xl ">Recent War Activity</span>
          <div className="flex gap-3">
            <Link href="feed" className={`px-4 py-2 flex items-center gap-2  select-none rounded-xl cursor-pointer ${pathname.includes("/feed") ? "bg-[#1475E1]" : "bg-white/10"} `}>
              Feed
            </Link>
            <Link href="rule" className={`px-4 py-2 flex items-center gap-2  select-none rounded-xl cursor-pointer ${pathname.includes("/rule") ? "bg-[#1475E1]" : "bg-white/10"} `}>
              War Rules
            </Link>
          </div>
        </div>
