  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        <div className="text-2xl ">Clan Members</div>
      ...
      <div className="w-full px-8 py-4 flex justify-between items-center gap-8 rounded-2xl bg-[#263244]/60">
        ...
        <div className="w-full flex items-center gap-4">
          ...
          <div className="flex gap-4 items-start">
            <div className="flex flex-col gap-2">
              <div className="text-2xl leading-6 ">BetKing</div>
        ...
        <div className="flex flex-col gap-2">
          <button className="h-full py-2 px-3 w-30 text-sm  rounded-lg cursor-pointer hover:bg-[#3b89e2] bg-[#1475E1]">Set to Elder</button>
          <button className="h-full py-2 px-3 w-30 text-sm  rounded-lg cursor-pointer hover:bg-[#e6baba] bg-[#FEE2E2] text-[#EF4444]">Kick</button>
        </div>
      </div>
    </div>
  )
