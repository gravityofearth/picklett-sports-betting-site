        ...
        <div className="grid grid-cols-2 max-md:grid-cols-1 gap-6">
          <div className="w-full flex gap-4 p-6 border border-[#FE9A0033] bg-linear-to-r from-[#FE9A001A] to-[#FF69001A] rounded-2xl">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-[#FEF3C6CC]">Stay on top of the action with our live leaderboard, showcasing players on winning streaks of 2 or more. Aim higher to unlock instant exclusive bonuses straight to your balance from $50 at 5 wins, to $200 at 10 wins. The more you win, the greater the rewards. (You dont need to bet on every game, just choose the ones you have confidence in!)</p>
            </div>
          </div>
              ...
              <table className="w-full border-collapse">
                ...
                <tbody>
                  ...
                  <tr className="">
                    ...
                    <td className="pl-1 py-2 pr-5">
                      <div className="flex gap-2 items-center">
                        <span className="text-[18px] text-[#01A3DB]">$70</span>
                  ...
                  <tr className="">
                    ...
                    <td className="pl-1 py-2 pr-5">
                      <div className="flex gap-2 items-center">
                        <span className="text-[18px] text-[#01A3DB]">$200</span>
