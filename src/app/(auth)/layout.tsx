                ...
                <div className="w-full flex justify-between items-center max-w-[1440px] px-6 py-3">
                    ...
                    <div className="flex gap-4 justify-between items-center max-md:gap-1">
                        ...
                        <div className="flex gap-[10px] items-center">
                            ...
                            <div className="relative">
                                <div onClick={() => { setShowUserDropdown(prev => !prev); setShowBalanceDropdown(false) }} className="relative w-8 h-8 rounded-full flex items-center justify-center bg-[#242C3C] cursor-pointer select-none overflow-hidden z-20 bg-cover bg-center" style={{ backgroundImage: `url(/avatars/${avatar})` }} >
                                    {avatar && !isError ?
                                        <Image onError={() => setError(true)} src={`/avatars/${avatar}`} className="hidden" width={32} height={32} alt="avatar" /> :
